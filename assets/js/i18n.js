const translations = {
    tr: {
        ...
        hero_p: "Tech4Peace ve Yeşil Okul Projesi'nin hazırladığı bu siteyle, aracınız için kaç ağaç dikilmesi gerektiğini hesaplayabilirsiniz. Hesaplama yaptıktan sonra ağaçları ekranda görebilirsiniz!",
        ...
        // Info Cards
        card_team_h3: "Tech4Peace Takımı",
        ...
        // Footer
        footer_p1: "Bu web sitesi, <strong>Açı Okulları Robotik Takımı</strong>, <strong>Tech4Peace</strong>, ve <strong>Yeşil Okul Projesi</strong> öğrencileri tarafından geliştirilmiştir.",
        ...
        team_h2_3: "Project Pangea ve Yeşil Kilometreler",
        team_p4_1: "<strong>Yeşil Kilometreler</strong> projesi, Tech4Peace takımlarının yürüttüğü <strong>Project Pangea</strong> adlı uluslararası çevre projesinin bir parçasıdır.",
        team_p4_2: "Yeşil Kilometreler projesinde, araçların ne kadar karbon saldığını hesaplıyor ve bu karbonu dengelemek için kaç ağaç dikilmesi gerektiğini gösteriyoruz. Bu sayede insanların çevresel etkilerini daha iyi anlamalarını hedefliyoruz.",
        team_h2_4: "Yeşil Okul Projesi ile İş Birliği",
        team_p5_1: "Bu projeyi <strong>Yeşil Okul Projesi</strong> ile birlikte yürütüyoruz. Birlikte okulumuzdaki araç kullanım verilerini topladık ve en çok kullanılan 20 araba ile 10 motosikleti belirledik. Bu verilerle Yeşil Kilometreler hesaplama sistemini geliştirdik.",
        ...
        // Project Page
        project_h1: "Yeşil Kilometreler Projesi Nasıl Ortaya Çıktı?",
        project_p1: "Merhaba! <strong>Yeşil Kilometreler</strong> projesi, biz öğrencilerin doğayı korumak için yaptığımız harika bir proje! Bu proje, <strong>Project Pangea</strong> adlı büyük bir projenin parçası.",
        project_h2_1: "Proje Nasıl Başladı?",
        project_p2_1: "Bir gün Tech4Peace takımı ve Yeşil Okul Projesi bir araya geldik ve şunu sorduk: 'Okulumuzda ve çevremizde karbon salımını nasıl azaltabiliriz?'",
        ...
        project_p2_2: "İşte bu yüzden Yeşil Kilometreler projesini yaptık! Bu web sitesi sayesinde, herkes arabasının ne kadar karbon saldığını öğrenebilir ve kaç ağaç dikmesi gerektiğini görebilir.",
        project_h2_2: "Nasıl Veri Topladık?",
        project_p3_1: "Bu projenin en güzel yanı, gerçek verilerle çalışması! Yeşil Okul Projesi öğrencileri, okul genelinde büyük bir anket yaptı:",
        ...
        project_h2_4: "Yeşil Kilometreler'in Hedefleri",
        project_p5_1: "Yeşil Kilometreler projesi ile şunları yapmak istiyoruz:",
        ...
        project_p6_1: "Yeşil Kilometreler hesaplama aracı, bilimsel verilere dayalı basit bir formül kullanır. Çok karmaşık değil, bakalım nasıl çalışıyor:",
        ...
        project_calc_note: "* Not: Bu değerler yaklaşık. Araç tipi, yakıt türü gibi şeylere göre değişebilir. Proje geliştikçe daha doğru hale getireceğiz!",
        project_h2_6: "Gelecek Adımlar",
        project_p7_1: "Yeşil Kilometreler projesi sürekli gelişen, dinamik bir çalışmadır. Önümüzdeki dönemde planladığımız geliştirmeler:",
        ...
        project_p8_1: "Yeşil Kilometreler, bir öğrenci projesidir ve sürekli gelişmektedir. Sizin de fikirleriniz ve geri bildirimleriniz bu projenin daha iyi hale gelmesine yardımcı olacaktır.",
        ...
        green_event5_p: "Yeşil Okul Projesi olarak WWF, TEMA Vakfı, ÇEKÜL ve benzeri çevre alanında faaliyet gösteren vakıf ve sivil toplum kuruluşlarının çalışmalarını takip ediyor; çevre bilincinin yaygınlaştırılması amacıyla bu kurumların projeleriyle uyumlu etkinlikler ve farkındalık çalışmaları yürütüyoruz. Bu iş birlikleri sayesinde çevresel sorunlara daha geniş bir perspektiften yaklaşarak, öğrencilerin sivil toplum bilinci kazanmasına katkı sağlıyoruz.",
        green_event6_h: "Sahil Temizliği",
        green_event6_p: "Denizlerimizi korumak için sahil temizliği etkinlikleri düzenliyoruz.",
        green_h2_4: "Yeşil Kilometreler'de Rolümüz",
        green_p6: "Yeşil Kilometreler projesi bizim en sevdiğimiz projelerden biri! Tech4Peace takımı ile birlikte bu harika web sitesini yaptık.",
        ...
        green_p8: "Yeşil Kilometreler projesinin temelini oluşturan araç verilerini toplamak için okul genelinde kapsamlı bir oylama çalışması yaptık.",
        ...
        green_p9: "Bu veriler sayesinde Yeşil Kilometreler hesaplayıcısı, okulumuzun gerçek verilerine dayalı sonuçlar üretebiliyor.",
        ...
        green_p10: "Yeşil Okul Projesi her öğrenciye açıktır. Sürdürülebilir bir gelecek için bize katıl!",
    ...
    en: {
        ...
        hero_p: "With this site prepared by Tech4Peace and Green School Club, you can calculate how many trees should be planted for your vehicle. You can see the trees on the screen after calculating!",
        ...
        card_project_h3: "Green Kilometers Project",
        ...
        // Footer
        footer_p1: "This website was developed by <strong>Açı Schools Robotics Team</strong>, <strong>Tech4Peace</strong>, and <strong>Green School Club</strong> students.",
        footer_copy: "© 2024 Green Kilometers | Project Pangea",
        footer_powered: "Powered By Zugo Bilgi Sistemleri A.Ş.",
        footer_insta: "Instagram: ",

        // About Team Page
        team_h1: "Who Are We? Tech4Peace Team",
        team_p1: "Hello! We are the <strong>Tech4Peace</strong> team. We are an FTC (FIRST Tech Challenge) student team working in the field of robotics and technology at Açı Schools. We love building robots and participate in national and international robotics competitions. But we don't just build robots; we also aim to benefit our environment and the world with technology.",
        ...
        team_h2_3: "Project Pangea and Green Kilometers",
        team_p4_1: "The <strong>Green Kilometers</strong> project is part of an international environmental project called <strong>Project Pangea</strong> run by Tech4Peace teams.",
        team_p4_2: "In the Green Kilometers project, we calculate how much carbon vehicles emit and show how many trees need to be planted to balance this carbon. Thus, we aim for people to better understand their environmental impacts.",
        team_h2_4: "Collaboration with Green School Club",
        team_p5_1: "We are running this project with the <strong>Green School Club</strong>. Together, we collected vehicle usage data in our school and identified the 20 cars and 10 motorcycles most used. We developed the Green Kilometers calculation system with this data.",
        ...
        // Project Page
        project_h1: "How Did the Green Kilometers Project Come About?",
        project_p1: "Hello! The <strong>Green Kilometers</strong> project is a wonderful project we students created to protect nature! This project is part of a larger project called <strong>Project Pangea</strong>.",
        project_h2_1: "How Did the Project Start?",
        project_p2_1: "One day, the Tech4Peace team and the Green School Club came together and asked: 'How can we reduce carbon emissions in our school and surroundings?'",
        ...
        project_p2_2: "That's why we created the Green Kilometers project! Thanks to this website, everyone can learn how much carbon their car emits and see how many trees need to be planted.",
        ...
        project_h2_4: "Goals of Green Kilometers",
        project_p5_1: "With the Green Kilometers project, we want to:",
        ...
        project_p6_1: "The Green Kilometers calculation tool uses a simple formula based on scientific data. It's not very complex, let's see how it works:",
        ...
        project_p7_1: "The Green Kilometers project is a constantly evolving, dynamic work. Improvements we plan for the coming period:",
        ...
        project_p8_1: "Green Kilometers is a student project and is constantly evolving. Your ideas and feedback will help make this project better.",
        ...
        green_event5_p: "Working with environmental organizations like WWF, TEMA Foundation, and ÇEKÜL, running projects.",
        green_event6_h: "Coastal Cleaning",
        green_event6_p: "Organizing coastal cleaning activities to protect our seas.",
        green_h2_4: "Our Role in Green Kilometers",
        green_p6: "The Green Kilometers project is one of our favorite projects! We made this wonderful website together with the Tech4Peace team.",
        ...
        green_p8: "We conducted a comprehensive voting study school-wide to collect the vehicle data that forms the basis of the Green Kilometers project.",
        ...
        green_p9: "Thanks to this data, the Green Kilometers calculator can produce results based on our school's real data.",
